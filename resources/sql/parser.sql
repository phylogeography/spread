...
UNION
SELECT id, user_id, readable_name, created_on, progress, status, (SELECT "BAYES_FACTOR_ANALYSIS") FROM bayes_factor_analysis JOIN bayes_factor_analysis_status ON bayes_factor_analysis_status.bayes_factor_analysis_id = bayes_factor_analysis.id) AS q1
